...
# __conda_setup="$('/home/lazy/codeDNA/confiFILES/appFrameWorkModule/python/conda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
# if [ $? -eq 0 ]; then
#     eval "$__conda_setup"
# else
#     if [ -f "/home/lazy/codeDNA/confiFILES/appFrameWorkModule/python/conda/etc/profile.d/conda.sh" ]; then
#         . "/home/lazy/codeDNA/confiFILES/appFrameWorkModule/python/conda/etc/profile.d/conda.sh"
#     else
#         export PATH="/home/lazy/codeDNA/confiFILES/appFrameWorkModule/python/conda/bin:$PATH"
#     fi
# fi
# unset __conda_setup
# # <<< conda initialize <<<
